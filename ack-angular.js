...
.directive('whiteOutModal',function(){//white-out-modal
  ...
  var template = '<div class="animate-fade" ng-show="show" style="position:fixed;top:0;left:0;z-index:20;height:100%;width:100%;background-color:rgba(255,255,255,.95);overflow:auto;">'+table+'</div>'
  return {
    restrict:'E'
    ,scope:{show:'='}
    ,transclude:true

...
$__System.register("1", ["2"], function (_export, _context) {
  ...
  var ngUiRouter, _classCallCheck, _createClass, deps, StateManagerService, inject, deps$1, StateManager, inject$1, stateManagerCom, deps$2, StateDocWatcher, inject$2, stateDocWatcher, ackState_module;
  ...
  */
  ...
  return {
    ...
    execute: function () {
      ...
      StateManagerService = function () {
        function StateManagerService() {
          _classCallCheck(this, StateManagerService);
        ...
        _createClass(StateManagerService, [{
          key: 'isBackHistory',
          ...
          key: 'stateChange',
          value: function stateChange(event, toState, toParams, fromState, fromParams) {
      ...
      inject = injector(StateManagerService, deps);
      deps$1 = ['StateManagerService', '$state', '$rootScope'];

      StateManager = function () {
        function StateManager() {
          _classCallCheck(this, StateManager);

          inject$1(arguments, this);
      ...
      inject$1 = injector(StateManager, deps$1);
      stateManagerCom = {
      ...
      StateDocWatcher = function () {
        function StateDocWatcher() {
          ...
          _classCallCheck(this, StateDocWatcher);

          inject$2(arguments, this);
          this.as = this.StateManagerService;

          var isBackButton = function isBackButton() {
            _this.isMouseOut = true;_this.StateManagerService.isOsAction = true;
          };
      ...
      inject$2 = injector(StateDocWatcher, deps$2);
      stateDocWatcher = {
        bindings: { as: '=?', onStateChange: '&' },
        controller: StateDocWatcher
      };
      ackState_module = angular.module('ack-state', [ngUiRouter]).service('StateManagerService', StateManagerService).component('stateManager', stateManagerCom).component('stateDocWatcher', stateDocWatcher).name;

      _export("default", ackState_module);
    }
  };
});
})
...
//# sourceMappingURL=ack-state.js.map